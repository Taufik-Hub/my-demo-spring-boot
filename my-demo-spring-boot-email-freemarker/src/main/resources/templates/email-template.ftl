			...
			<td align="center" valign="top" bgcolor="#838383"
				...
				<table width="600" border="0" cellspacing="0" cellpadding="0">
					...
					<div style="font-size: 24px; color: #555100;">
							...
							<div>
								<br> 
								${bikeinfo.make}  &nbsp;    ${bikeinfo.model}   &nbsp;   ${bikeinfo.year}
								<br>
								 <img src="logo.png" alt="Logo"/> <--classpath:/!-->
								  <img src="src/main/resources/logo1.png" alt="Logo"/> 
								<br>
							</div>
