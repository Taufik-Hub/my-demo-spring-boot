package com.file.upload.download.controller;
...
import com.file.upload.download.dto.UploadFileResponse;
import com.file.upload.download.service.DocumentStorageService;
...
public class DocumentController {
	...
	public ResponseEntity<String> checkService(){
		...
		return ResponseEntity.ok().body("Document Service is up and running on port : "+port);
	}
