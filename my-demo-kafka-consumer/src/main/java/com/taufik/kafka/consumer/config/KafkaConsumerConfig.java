package com.taufik.kafka.consumer.config;
...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, UserDetails> userDetailsConsumerFactory() {
		...
		DefaultKafkaConsumerFactory<String, UserDetails> userDetailsKafkaConsumerFactory = new DefaultKafkaConsumerFactory<>(
				configs, new StringDeserializer(), new JsonDeserializer<>(UserDetails.class));
